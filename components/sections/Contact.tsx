      ...
      <Reveal>
        <div className="grad-border relative overflow-hidden rounded-2xl bg-surface p-8 sm:p-12">
          ...
          <div
            ...
            style={{ background: "radial-gradient(closest-side, rgba(34,211,238,0.16), transparent 70%)" }}
          />
              ...
              {hasBooking ? (
                <>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-md border border-border bg-surface px-5 py-3 text-sm text-foreground transition-colors hover:border-accent/50 hover:text-accent"
                  >
              ...
              <div className="mt-8 flex flex-wrap items-center gap-2">
                {activeSocials.map((s) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    className="group inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-1.5 text-sm text-muted transition-colors hover:border-accent/50 hover:text-accent"
                  >
                    {s.label}
                    <ArrowUpRight
                      width={14}
